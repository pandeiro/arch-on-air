...
** Procedure
*** Make bootable USB media with Arch ISO image ([[https://wiki.archlinux.org/index.php/USB_Flash_Installation_Media][wiki]])
*** Hold the <alt/option> key and boot into USB
*** Create partitions
